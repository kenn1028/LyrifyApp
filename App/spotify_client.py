    ...
    *Output: varies (based from desired output of the function)
    ...
    def get_current_song(self):
        ...
        return {
            ...
            'track_length':  datetime.timedelta(milliseconds=data["item"]["duration_ms"]),
            'progress': datetime.timedelta(milliseconds=data["progress_ms"])
        }
    ...
    #search functions; no scopes needed, basic access_token
